...
## <b>** Important! Please make sure that you change your passwords for user root and mapr immediately after you ssh into all the VMs by issuing 'passwd" command to enforce good security practice.</b>
